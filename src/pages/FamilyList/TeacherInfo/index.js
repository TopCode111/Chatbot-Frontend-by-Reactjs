...
import useTeacherAdd from "../../../hooks/teacher/useTeacherAdd";
import { useGetTeacher } from "../../../hooks/teacher/useGetTeacher";
import { interceptor } from "../../../utils/interceptor";
import { useTeacherUpdate } from "../../../hooks/teacher/useTeacherUpdate";
import { useDeleteMember } from "../../../hooks/teacher/useDelete";
...
export default function TeacherInfo(props) {
  const { mutate: addMember } = useTeacherAdd();
  const { mutate: updateMember } = useTeacherUpdate();
  const { mutate: deleteMember } = useDeleteMember();
  const { data: teachers } = useGetTeacher();
